...
services:
  migrate: { image: "ghcr.io/pr0h0/openmanga-app:0.2.0", build: !reset null }
  api: { image: "ghcr.io/pr0h0/openmanga-app:0.2.0" }
  worker: { image: "ghcr.io/pr0h0/openmanga-app:0.2.0" }
  mock-ai: { image: "ghcr.io/pr0h0/openmanga-app:0.2.0" }
  nginx: { image: "ghcr.io/pr0h0/openmanga-nginx:0.2.0", build: !reset null }
  kokoro: { image: "ghcr.io/pr0h0/openmanga-kokoro:0.2.0", build: !reset null }
```
